    ...
    <header className={`pharma-header ${isScrolled ? 'scrolled' : ''}`}>
      <div className="top-strip">
        <div className="strip-inner">
          <div className="strip-left">
            ...
            <span className="strip-item">
              <i className="fas fa-headset"></i> Hotline:{' '}
              <strong>08 1234 4540</strong>
            </span>
          </div>
              ...
              <div className="search-dropdown">
                {searchMatches.length === 0 ? (
                  <div className="search-empty">
                    <i className="far fa-face-frown"></i> Không tìm thấy sản
                    phẩm phù hợp.
                  </div>
                ) : (
      ...
      <nav className="nav-bar">
        <div className="nav-inner">
          ...
          >
            <button
              className={`nav-link has-dropdown ${hoveredMenu === 'thuoc' ? 'active' : ''}`}
            >
              Thuốc
              <i className="fas fa-chevron-down nav-chevron"></i>
            </button>
            <div
              className={`nav-dropdown nav-dropdown--categories ${hoveredMenu === 'thuoc' ? 'show' : ''}`}
            >
          ...
          <button
            className="nav-link"
            onClick={() => navigate('/products?category=8')}
          >
            Mẹ và bé
          </button>
