    ...
    <footer className="highlands-footer">
      <div className="footer-content">
        <div className="footer-left">
          ...
          <div className="footer-certifications">
            ...
            <img
              src={dmca}
              alt="DMCA Protected"
              className="cert-img dmca-img"
            />
            <img
              src={legitScript}
              alt="LegitScript"
              className="cert-img legit-img"
            />
          </div>
        </div>
        ...
        <div className="footer-middle">
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="/services">Dịch vụ chăm sóc sức khỏe</a>
              </li>
              <li>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              <li>
                <a href="/products">Thuốc & Thực phẩm chức năng</a>
              </li>
              <li>
                <a href="/equipment">Dụng cụ y tế</a>
              </li>
              <li>
                <a href="/find-store">Tìm nhà thuốc gần nhất</a>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-right">
          ...
          <div className="footer-payment-methods">
            <h3 className="footer-column-title payment-title">
              HỖ TRỢ THANH TOÁN
            </h3>
      ...
      <div className="footer-disclaimer">
        <p>
          ...
          thuốc chữa bệnh. Vui lòng đọc kỹ hướng dẫn sử dụng trước khi dùng,
          hoặc tham khảo ý kiến của Bác sĩ / Dược sĩ.
        </p>
      </div>
    </footer>
  );
