  ...
  const handleAddToCart = (redirect = false) => {
    ...
    if (existingItemIndex >= 0) {
      ...
      cart[existingItemIndex] = {
        ...existingItem,
        quantity: Number(existingItem.quantity || 0) + qty,
        addedAt: currentTime,
      };
    } else {
      cart.push({ ...product, quantity: qty, addedAt: currentTime });
    }
      ...
      <div className="detail-card">
        ...
        <div className="detail-info">
          ...
          <div className="detail-commitments">
            <p>
              <i className="fas fa-check-circle"></i> Cam kết 100% thuốc/thực
              phẩm chính hãng.
            </p>
            <p>
              <i className="fas fa-sync-alt"></i> Đổi trả trong vòng 30 ngày nếu
              có lỗi.
            </p>
            <p>
              <i className="fas fa-user-md"></i> Được tư vấn trực tiếp bởi Dược
              sĩ chuyên môn.
            </p>
          </div>
        ...
        <div className="tabs-content">
          {activeTab === 'description' && (
            <div className="tab-pane">
              ...
              <p>
                {product.description ||
                  'Thông tin mô tả chi tiết của sản phẩm này đang được cập nhật...'}
              </p>
            </div>
          )}
          {activeTab === 'ingredients' && (
            <div className="tab-pane">
              ...
              <p>
                {product.ingredients ||
                  'Thông tin thành phần của sản phẩm này đang được cập nhật...'}
              </p>
            </div>
          )}
          {activeTab === 'usage' && (
            <div className="tab-pane">
              ...
              <p>
                {product.usage ||
                  'Sử dụng theo đúng chỉ định của bác sĩ hoặc hướng dẫn in trên bao bì sản phẩm.'}
              </p>
            </div>
          )}
          {activeTab === 'note' && (
            <div className="tab-pane">
              ...
              <p>
                {product.note ||
                  'Bảo quản nơi khô ráo, thoáng mát. Tránh xa tầm tay trẻ em. Đọc kỹ hướng dẫn sử dụng trước khi dùng.'}
              </p>
            </div>
          )}
        </div>
